...
on t2.PackageType=t5.id
 where t1.id=:bookindid";
                  ...
                  <tr>
                   ...
                   <td><?php echo $result->PackageDuration; ?></td>
                    <th>Price</th>
	...
	- Author Name: Samridhi, Ujjwal
	 -->
               ...
               <td>  
                ...
                {
                  echo ' <button type="button" class="btn btn-primary" disabled="" data-toggle="modal" data-target="#myModal">Take Action</button>';

                }
                else{
echo ' <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Take Action</button>';                }
