...
$titlename = $_POST['titlename'];$package = $_POST['package'];$PackageDuration = $_POST['PackageDuration'];$Price = $_POST['Price'];$photo = $_POST['photo'];$description = $_POST['description'];

$sql="INSERT INTO tbladdpackage (category,titlename,PackageType,PackageDuration,Price,uploadphoto,Description) 
Values(:category,:titlename,:package,:PackageDuration,:Price,:photo,:description)";
	 ...
	 -->
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="PackageDuration" name="PackageDuration" placeholder="Enter Package Duration">
                </div>
